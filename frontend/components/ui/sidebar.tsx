  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "w-[--sidebar-width] flex flex-col w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
function SidebarMenuButton({
  ...
  const button = (
    <Comp
      ...
      className={cn(sidebarMenuButtonVariants({ variant, size }), "whitespace-normal break-words w-full justify-start", className)}
      {...props}
    />
  )
